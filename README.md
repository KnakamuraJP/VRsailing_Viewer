...
このリポジトリは、VRsailing 用に Samsung Gear 360（2017年製）で撮影し、前処理を施した360°映像(画像)を特殊な変換ソフトを嚙まさずにスマートフォンやPCで画面をドラッグ、またはスワイプして視点を動かして見られるように GitHub Pages 上に設置した公開サイトです。
